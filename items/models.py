...
class Item(models.Model):
    """ Represents a single item page. """
    food_name = models.CharField(max_length=settings.ITEM_PAGE_TITLE_MAX_LENGTH, unique=True,
                             )
    author = models.ForeignKey(User, on_delete=models.PROTECT,
                               help_text="The user that posted the item.") # this User is a object of class User that django has
    slug = models.CharField(max_length=settings.ITEM_PAGE_TITLE_MAX_LENGTH, blank=True, editable=False,
